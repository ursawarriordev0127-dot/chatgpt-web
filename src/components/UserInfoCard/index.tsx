      ...
      <div className={styles.userInfo_card}>
        ...
        <div className={styles.userInfo_info}>
          <div className={styles.userInfo_info_title}>
            ...
            {
              isSvip ? <Tooltip title="Super Member"><img src={vipIcon.svip} alt="" /></Tooltip> : 
              vipDay ? <Tooltip title="Member"><img src={vipIcon.vip} alt="" /></Tooltip>: ''
            }
          </div>
        ...
        <div className={styles.userInfo_vip}>
          <Space wrap size="large">
            <Statistic title="Points" value={info?.integral} />
            <Statistic title="Member" value={vipDay} />
          </Space>
        </div>
      </div>
      {props.children}
