...
function PluginModal(props: Props) {
  ...
  return (
    <Modal title="AI Smart Plugins" open={props.open} width={700} footer={null} onCancel={props.onCancel}>
      <Tabs
        // tabBarExtraContent={<Button>Create Plugin</Button>}
        items={[
          {
            label: 'Marketplace',
            key: 'shichang',
